...
type Props = {
  ...
  onChangeSimpleVitsUrl: (event: React.ChangeEvent<HTMLInputElement>) => void;//vits
            ...
            {(() => {
                ...
                console.log("selectVoice: "+ selectVoice)
                  return (
                    <>
                      <div>
                        Simple Vits APIを使用しています。
                      </div>
                      <div className="mt-16 font-bold">Simple Vits API URL</div>
                      <div className="mt-8">
                        <input
                          ...
                          placeholder="..."
                          value={simpleVitsUrl}
                          onChange={onChangeSimpleVitsUrl}
                        />
                      </div>
                    </>
                  );
                ...
                {chatLog.map((value, index) => {
                  return (
                    ...
                    >
                      ...
                      ></input><button onClick={() => onChangeChatLog(index,"")}>[del]</button> 
